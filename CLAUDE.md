...
- Vacuum shells v2 (2026-09-05, direction validated on `docs/concepts/sheet.png`, generated by
  `tools/assets/concepts.py`): `VacuumModelsV2` builds faceted flat-shaded revolves (`MeshKit.Flat`), grooves and
  seams in the profiles, bolted panels, translucent bins (`Palette.Glass`, Fade), emissive LEDs and tiny displays
